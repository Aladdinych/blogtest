...
/** Пустая строка - это        **/
/** разделитель                **/
/** Если перед строкой из файла**/
/** три пустые - начало блока  **/
/** одна пустая - это элемент  **/
/** блока                      **/
/**                            **/
...
/** разделитель                **/
/**                            **/
/** Формируем массив blocks    **/
/** каждый элемент которого    **/
/** это массив строк этого     **/
/** блока.                     **/
/**                            **/
/** Если длина строки <= 80    **/
/** символов - она игнорируется**/
/**                            **/
/********************************/
...
/** данными из массива blocks.   **/
/**                              **/
/** Первая строка блока - данные **/
/** категории.                   **/
/** Остальные строки блока - это **/
/** статьи.                      **/
/**                              **/
/** Если блок содержит менее 2   **/
/** строк, он игнорируется.      **/
/**                              **/
/** Первое предложение строки -  **/
/** это title.                   **/
/** Первые 250 символов строки,  **/
/** но до конца предложения      **/
/** - это description.           **/
/** Строка без первого           **/
/** предложения - это body.      **/
/**                              **/
/**********************************/
